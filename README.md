...
- [macbre/docker-nginx-http3](https://github.com/macbre/docker-nginx-http3) - Stable and up-to-date root-less nginx with quic + http/3, google brotli compression, njs, GeoIP2, and Grade A+ SSL config
...
- [Patchett/CryptoBuddy](https://github.com/Patchett/CryptoBuddy) - Android app which displays cryptocurrency prices, charts and news!
...
- [Statemood/dockerfiles](https://github.com/Statemood/dockerfiles) - Dockerfile & kubernetes Yaml Templates
